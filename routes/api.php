...
Route::middleware('auth:api')->group(function () {
    ...
    Route::group(['prefix' => 'user'], static function(){
        ...
        Route::get('/details', 'AuthenticationController@detail');          //http://127.0.0.1:8000/api/user/details
        Route::get('/me', 'AuthenticationController@me');                   //http://127.0.0.1:8000/api/user/me
    });
});
